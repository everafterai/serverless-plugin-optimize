  ...
  constructor(serverless, options) {
    ...
    if (validRunTime) {
      ...
      if (this.serverless.service.provider.runtime) {
        nodeVersion =
          this.serverless.service.provider.runtime.split("nodejs")[1];
      }
      ...
      if (this.custom && this.custom.optimize) {
        ...
        if (typeof this.custom.optimize.externalPaths === "object") {
          this.optimize.options.externalPaths =
            this.custom.optimize.externalPaths;
        }
        ...
        if (Array.isArray(this.custom.optimize.includePaths)) {
          this.optimize.options.includePaths =
            this.custom.optimize.includePaths;
        }
      ...
      this.hooks = {
        "after:package:function:package":
          this.afterCreateDeploymentArtifacts.bind(this),
        "before:package:function:package":
          this.beforeCreateDeploymentArtifacts.bind(this),
